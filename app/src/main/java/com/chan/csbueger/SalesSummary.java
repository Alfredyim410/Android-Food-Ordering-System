...
public class SalesSummary extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle((Html.fromHtml("<font color=\"#FFFFFF\">" + "Sales Summary")));
        ...
        URL = getString(R.string.filename_salessummary) + "?strmemberid=" + strmemberid.toString() + "&begindate=" + strdate.toString() + "&enddate=" + strdate1.toString();
        ...
        switch (item.getItemId()) {
            ...
            case R.id.actPdf:
                if (Build.VERSION.SDK_INT > Build.VERSION_CODES.KITKAT) {
                    ...
                    Toast.makeText(SalesSummary.this, "No PDF Service Available!",Toast.LENGTH_SHORT).show();
                }
    ...
    private void createWebPrintJob(WebView webView) {
        ...
        String jobName = getString(R.string.app_name)  + " Sales Summary - "  + strdate;
